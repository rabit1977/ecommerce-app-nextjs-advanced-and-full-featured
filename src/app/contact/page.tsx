      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="rounded-xl border bg-white p-6 shadow-lg dark:bg-slate-950 dark:border-slate-800">
              <h2 className="text-2xl font-semibold dark:text-white">Our Location</h2>
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">support@electro.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border bg-white p-6 shadow-lg dark:bg-slate-950 dark:border-slate-800">
              <h2 className="text-2xl font-semibold dark:text-white">Business Hours</h2>
